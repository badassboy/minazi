...
if(isset($_POST['add-cat'])){
	...
	$data = array(
		...
		'cat_img' => isset($ext_path)? $ext_path : '',
	);
	$op->insert(categories, $data);
	$_SESSION['success-me'] = '<strong>Good!</strong> '.$_POST['cat_name'].' Added Successfully!';
							...
							<div class="card-body">
								<div class="row">
									<div class="col mb-3">
										...
										<input type="text" class="form-control" placeholder="Category's Name" value="" name="cat_name">
									</div>
								</div>
								<hr>
								<div class="row">
									<div class="col">
										<input type="submit" class="btn btn-primary form-control" name="add-cat" value="Add Category">
									</div>
								</div>
							</div>
						</div>
