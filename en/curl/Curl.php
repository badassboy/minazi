...
class Curl
{
    ...
    {
        $this->jsonDecoder = 'Decoder::decodeJson';
    ...
    {
        $this->xmlDecoder = 'Decoder::decodeXml';
    ...
    public function setDefaultDecoder($mixed = 'json')
    {
        if ($mixed === false) {
            ...
            if ($mixed === 'json') {
                $this->defaultDecoder = 'Decoder::decodeJson';
            } elseif ($mixed === 'xml') {
                $this->defaultDecoder = 'Decoder::decodeXml';
            }
        }
    }
